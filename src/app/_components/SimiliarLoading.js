export const SimiliarLoading = () => {
  return (
    <div className="flex gap-[52px] max-sm:w-full  ">
      <div className="flex flex-col pl-[80px] pr-[80px] gap-8 max-sm:p-5 ">
        <div className="flex flex-row justify-between pt-[52px]">
          <div className="w-[250px] h-[32px] bg-gray-300 rounded-full dark:bg-[#27272A]"></div>
        </div>
        <div className="flex ">
